...
public class TempServiceProcess : System.Web.Services.WebService {
    ...
    [WebMethod]
    public OneFRAME.Core.Model.AjaxOut UploadMedia(string SecurityCode, string Xml, string XmlSchema,  string RenderInfoXml,string RenderInfoXmlSchema, byte[] Bytes)
    {
        return TempServiceUtility.UploadMedia(SecurityCode, Xml, XmlSchema, RenderInfoXml, RenderInfoXmlSchema, Bytes);
    }

    [WebMethod]
    public OneFRAME.Core.Model.AjaxOut DownloadMedia(string SecurityCode, string Xml, string XmlSchema, string RenderInfoXml, string RenderInfoXmlSchema)
    {
        return TempServiceUtility.DownloadMedia(SecurityCode, Xml, XmlSchema, RenderInfoXml, RenderInfoXmlSchema);
    }

    [WebMethod]
    public OneFRAME.Core.Model.AjaxOut GetMediaInfo(string SecurityCode, string Xml, string XmlSchema, string RenderInfoXml, string RenderInfoXmlSchema)
    {
