...
public class FuncWebServiceProcess : System.Web.Services.WebService {
    ...
    [WebMethod]
    public OneFRAME.Core.Model.AjaxOut ProcessComand(
        string SecurityCode,
        string XmlData,
        string XmlDataSchema)
    {
        return OneFRAME.ProcessWebService.Utility.ProcessWebServiceUtility.ProcessComand(SecurityCode, XmlData, XmlDataSchema);
    }
