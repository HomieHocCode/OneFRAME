...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        OneFRAME.Core.Model.SiteParam 
            OSiteParam = OneFRAME.Utility.WebEnvironments.CreateSiteParam(ORenderInfo);
        OneFRAME.Utility.WebSessionUtility.SetCurrentLoginUser(OSiteParam, null);
        OneFRAME.Core.Model.AjaxOut OAjaxOut = WebScreenRender.DrawLoginPage(ORenderInfo);
        placeHolderContent.Controls.Clear();
