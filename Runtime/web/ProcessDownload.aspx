...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string ServiceId = (string)OneFRAME.Utility.WebEnvironments.Request("ServiceId");
        string ObjectId = (string)OneFRAME.Utility.WebEnvironments.Request("ObjectId");
        OneFRAME.Core.Model.AjaxOut RetAjaxOut = OneFRAME.Utility.DownloadUtility.Download(ORenderInfo, ServiceId, ObjectId);
        if (RetAjaxOut.Error)
        {
