...
<script runat="server">
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string thietbiid = OneFRAME.Utility.WebEnvironments.Request("thietbiid");
        ...
        OneFRAME.Core.Model.AjaxOut
            RetAjaxOut = OneFRAME.Utility.RemoteDataUtility.Find(ServiceId).Reading(ORenderInfo, iPage, q, thietbiid);
