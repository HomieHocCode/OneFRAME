...
<script runat="server">
    ...
    {
        //string Data=OneFRAME.JSONP.OrderUtility.GetData();
        ...
        string filter = OneFRAME.Utility.WebEnvironments.Request("filter");
        ...
        OneFRAME.Core.Model.AjaxOut RetAjaxOut = null;
        if (string.IsNullOrEmpty(filter))
            RetAjaxOut = OneFRAME.Utility.RemoteDataUtility.Find(ServiceId).Reading(ORenderInfo, iPage, q);
        else RetAjaxOut = OneFRAME.Utility.RemoteDataUtility.Find(ServiceId).Reading(ORenderInfo, iPage, q, filter);
