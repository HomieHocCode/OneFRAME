        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneLIS.WebParts.QuotationAgencyTemplate.ServerSideDrawAddForm(RenderInfo).value;\r\n" +
                    ...
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OneLIS.WebParts.QuotationAgencyTemplate.ServerSideDrawUpdateForm(RenderInfo, QuotationAgencyTemplateId).value;\r\n" +
                    "       document.getElementById('divActionForm').innerHTML=AjaxOut.HtmlContent;\r\n" +
                    "       document.getElementById('divActionForm').style.display='block';\r\n" +
                    "       document.getElementById('divListForm').style.display='none';\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.QuotationAgencyTemplate.ServerSideAdd(RenderInfo, Subject, Header, Footer, Css, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n"+
                    "       {\r\n"+
                    ...
                    "       SortIndex = document.getElementById('txtSortIndex').value;\r\n" +
                    "       Active = parseInt(document.getElementById('drpSelectActive').value,10);\r\n" +
                    "       AjaxOut = OneLIS.WebParts.QuotationAgencyTemplate.ServerSideUpdate(RenderInfo, QuotationAgencyTemplateId, Subject, Header, Footer, Css, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "           AjaxOut = OneLIS.WebParts.QuotationAgencyTemplate.ServerSideDelete(RenderInfo, QuotationAgencyTemplateId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "       OneLIS.WebParts.QuotationAgencyTemplate.ServerSideDrawSearchResult(RenderInfo, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
