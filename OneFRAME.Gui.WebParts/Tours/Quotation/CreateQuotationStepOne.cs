        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneLIS.WebParts.CreateQuotationStepOne.ServerSideProcess(RenderInfo, StartDate, Adults, Children, NoOfRoom, HotelCategoryId, CustomerName, CustomerAddress, CustomerMobile, CustomerEmail, QuotationAgencyTemplateId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.CreateQuotationStepOne.ServerSideProcessFromTemplate(RenderInfo, QuotationTemplateId, StartDate, Adults, Children, NoOfRoom).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
