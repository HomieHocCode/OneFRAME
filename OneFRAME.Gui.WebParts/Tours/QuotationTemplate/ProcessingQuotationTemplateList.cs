        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneLIS.WebParts.ProcessingQuotationTemplateList.ServerSiteUpdate(RenderInfo, QuotationTemplateId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n"+
                    "       {\r\n"+
                    ...
                    "           AjaxOut = OneLIS.WebParts.ProcessingQuotationTemplateList.ServerSideDelete(RenderInfo, QuotationTemplateId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "       OneLIS.WebParts.ProcessingQuotationTemplateList.ServerSideDrawSearchResult(RenderInfo, Keyword, CallBackReading);\r\n" +
                    "   }\r\n" +
