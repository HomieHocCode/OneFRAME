...
using OneLIS.Core.Call.Bussiness.Utility;
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                   ...
                   "        window.open('" + BackUrl + "','_self');\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideDeleteRangePrice(RenderInfo, RangeSalePriceId, ServiceId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideAddRangePrice(RenderInfo, ServiceId, StartDate, EndDate, StartTime, EndTime, FromPax, ToPax).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideAddShared(RenderInfo, ServiceId, OwnerId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "           AjaxOut = OneLIS.WebParts.UpdateService.ServerSideDeleteServiceSharedOwner(RenderInfo, ServiceSharedOwnerId, ServiceId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
                    ...
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideAdd(RenderInfo, ServiceTypeId).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideUpdateSalePrice(RenderInfo, RangeServicePriceId, SalePrice).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           if(ShowInfo)\r\n" +
                    "           {\r\n" +
                    ...
                    "       document.getElementById('divProcessingUpdate').innerHTML='';\r\n" +
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideUpdateWebPrice(RenderInfo, RangeServicePriceId, WebPrice).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           if(ShowInfo)\r\n" +
                    "           {\r\n" +
                    ...
                    "       document.getElementById('divProcessingUpdate').innerHTML='';\r\n" +
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideUpdateServiceSharedOwner(RenderInfo, ServiceSharedOwnerId, MarkUpPercent).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           if(ShowInfo)\r\n" +
                    "           {\r\n" +
                    ...
                    "       AjaxOutService = OneLIS.WebParts.UpdateService.ServerSideCreateServiceObject(RenderInfo, ServiceId, ServiceTypeExtraInfoIds).value;\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.UpdateService.ServerSideUpdate(RenderInfo, ServiceId, OSaveService, ServiceTypeExtraInfos).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
