            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                   ...
                   "        window.open('" + BackUrl + "','_self');\r\n" +
                    ...
                    "       OSaveService = OneLIS.WebParts.AddService.ServerSideCreateServiceObject(RenderInfo, null).value.RetObject;\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.AddService.ServerSideAdd(RenderInfo, OSaveService, Type).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
