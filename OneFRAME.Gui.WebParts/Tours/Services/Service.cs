        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneLIS.WebParts.Service.ServerSideAddService(RenderInfo, ServiceTypeId).value;\r\n" +
                    ...
                    "   {\r\n" +
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OneLIS.WebParts.Service.ServerSideUpdateService(RenderInfo, ServiceId).value;\r\n" +
                    "       window.open(AjaxOut.RetUrl,'_self');\r\n" +
                    "   }\r\n" +
                    ...
                    "           AjaxOut = OneLIS.WebParts.Service.ServerSideDelete(RenderInfo, ServiceId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.Service.ServerSideBuildUrl(RenderInfo, ServiceTypeId, AssetSupplierId, FilterType, Keyword, Status, PageIndex).value;\r\n" +
                    "       window.open(AjaxOut.RetUrl,'_self');\r\n"+
                    "   }\r\n" +
                    ...
                    "       Keyword = document.getElementById('txtKeyword').value;\r\n" +
                    "       Status = document.getElementById('drpSelectStatus').value;\r\n" +
                    "       AjaxOut = OneLIS.WebParts.Service.ServerSideBuildUrl(RenderInfo, ServiceTypeId, AssetSupplierId, FilterType, Keyword, Status, 0).value;\r\n" +
                    "       window.open(AjaxOut.RetUrl,'_self');\r\n"+
                    "   }\r\n" +
                    ...
                    "   {\r\n"+
                    "       RenderInfo=CreateRenderInfo();\r\n" +
                    "       AjaxOut = OneLIS.WebParts.Service.ServerSideDrawImportFromExcel(RenderInfo).value;\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.Service.ServerSideImportFromExcel(RenderInfo, XmlInfoResult).value;\r\n" +
