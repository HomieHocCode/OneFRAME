        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       OSaveCaseProfile = OneLIS.WebParts.ManageCaseProfile.ServerSideCreateCaseProfileObject(RenderInfo, CaseProfileId).value.RetObject;\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.ManageCaseProfile.ServerSideUpdate(RenderInfo, CaseProfileId, OSaveCaseProfile).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
