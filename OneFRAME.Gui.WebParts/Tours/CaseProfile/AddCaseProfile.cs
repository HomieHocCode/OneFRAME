            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                   ...
                   "        window.open('" + BackUrl + "','_self');\r\n" +
                    ...
                    "       OSaveCaseProfile = OneLIS.WebParts.AddCaseProfile.ServerSideCreateCaseProfileObject(RenderInfo, null).value.RetObject;\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.AddCaseProfile.ServerSideAdd(RenderInfo, OSaveCaseProfile).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
