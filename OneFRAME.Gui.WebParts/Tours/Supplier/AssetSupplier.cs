        ...
        public override AjaxOut Draw(SiteParam OSiteParam, RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                RetAjaxOut.HtmlContent =
                    ...
                    "       AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideOpenLink(RenderInfo, ServiceTypeId, FilterTypeId, Status, Keyword, 0).value;\r\n" +
                    ...
                    "       Status = document.getElementById('drpSelectStatus').value;\r\n" +
                    "       Keyword = document.getElementById('txtKeyword').value;\r\n" +
                    "       AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideOpenLink(RenderInfo, ServiceTypeId, FilterTypeId, Status, Keyword, PageIndex).value;\r\n" +
                    "       window.open(AjaxOut.RetUrl,'_self');\r\n" +
                    "   }\r\n" +
                    ...
                    "       Status = document.getElementById('drpSelectStatus').value;\r\n" +
                    "       Keyword= document.getElementById('txtKeyword').value;\r\n" +
                    "       AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideDrawSearchResult(RenderInfo, OwnerId, ServiceTypeId, FilterTypeId, Keyword, Status, PageIndex).value;\r\n" +
                    ...
                    "       Status = document.getElementById('drpSelectStatus').value;\r\n" +
                    "       Keyword = document.getElementById('txtKeyword').value;\r\n" +
                    "       AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideDrawAddForm(RenderInfo, ServiceTypeId, FilterTypeId, Status, Keyword, 0).value;\r\n" +
                    "       window.open(AjaxOut.RetUrl,'_self');\r\n" +
                    "   }\r\n" +
                    ...
                    "       Status = document.getElementById('drpSelectStatus').value;\r\n" +
                    "       Keyword = document.getElementById('txtKeyword').value;\r\n" +
                    "       AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideDrawUpdateForm(RenderInfo, AssetSupplierId, ServiceTypeId, FilterTypeId, Status, Keyword, 0).value;\r\n" +
                    "       window.open(AjaxOut.RetUrl,'_self');\r\n" +
                    "   }\r\n" +
                    ...
                    "       AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideAdd(RenderInfo, CityId, OwnerId, ServiceTypeId, AssetSupplierCode, AssetSupplierName, Address, Hotline, Fax, Vat, LicenceSale, WebSite, GoogleAddress, AssetSupplierLevel, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    ...
                    "       SortIndex = document.getElementById('txtSortIndex').value;\r\n" +
                    "       Active = parseInt(document.getElementById('drpSelectActive').value,10);\r\n" +
                    "       AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideUpdate(RenderInfo, AssetSupplierId, CityId, AssetSupplierCode, AssetSupplierName, Address, Hotline, Fax, Vat, LicenceSale, WebSite, GoogleAddress, AssetSupplierLevel, SortIndex, Active).value;\r\n" +
                    "       if(AjaxOut.Error)\r\n" +
                    "       {\r\n" +
                    "           callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "           return;\r\n" +
                    ...
                    "           AjaxOut = OneLIS.WebParts.AssetSupplier.ServerSideDelete(RenderInfo, AssetSupplierId).value;\r\n" +
                    "           if(AjaxOut.Error)\r\n" +
                    "           {\r\n" +
                    "               callSweetAlert(AjaxOut.InfoMessage);\r\n" +
                    "               return;\r\n" +
