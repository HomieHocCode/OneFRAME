        ...
        public static AjaxOut ServerSideDrawAddForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "       AjaxOut = OneLIS.WebParts.AddAssetSupplier.ServerSideAdd(RenderInfo, CityId, OwnerId, ServiceTypeId, AssetSupplierCode, AssetSupplierName, Address, Hotline, Fax, Vat, LicenceSale, WebSite, GoogleAddress, AssetSupplierLevel, SortIndex, Active).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
