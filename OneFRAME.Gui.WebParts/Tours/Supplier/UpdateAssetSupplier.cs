        ...
        public static AjaxOut ServerSideDrawUpdateForm(RenderInfoCls ORenderInfo)
        {
            ...
            try
            {
                ...
                string Html =
                        ...
                        "       AjaxOut = OneLIS.WebParts.UpdateAssetSupplier.ServerSideUpdate(RenderInfo, AssetSupplierId, CityId, AssetSupplierCode, AssetSupplierName, Address, Hotline, Fax, Vat, LicenceSale, WebSite, GoogleAddress, AssetSupplierLevel, SortIndex, Active).value;\r\n" +
                        "       if(AjaxOut.Error)\r\n" +
                        "       {\r\n" +
