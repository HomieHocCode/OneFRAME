...
namespace OneFRAME.Bussiness.Template
{
    public interface IDanhMucDonViHanhChinhProcess
    {
        ...
        DanhMucDonViHanhChinhCls[] PageReading(ActionSqlParamCls ActionSqlParam, DanhMucDonViHanhChinhFilterCls ODanhMucDonViHanhChinhFilter, ref int recordTotal);
    ...
    public class DanhMucDonViHanhChinhTemplate : IDanhMucDonViHanhChinhProcess
    {
        ...
        public virtual DanhMucDonViHanhChinhCls[] PageReading(ActionSqlParamCls ActionSqlParam, DanhMucDonViHanhChinhFilterCls ODanhMucDonViHanhChinhFilter, ref int recordTotal) { return null; }
